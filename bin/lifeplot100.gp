...
echo "set xlabel 'step (1,000 turns)'" > tmp.gp
echo "set ylabel 'Normalized Beam Intensity'" >> tmp.gp
echo "set key right top box" >> tmp.gp
echo "set grid" >> tmp.gp
echo "set xrange [0:100]" >> tmp.gp

echo "plot \\" >> tmp.gp
i=1
for dir in $@ ; do 
if (($i<$#)) ; then
echo "'${dir}/intensity.txt' title '${pn[$i]}' w l lw 5,\\" >> tmp.gp
else
echo "'${dir}/intensity.txt' title '${pn[$i]}' w l lw 5" >> tmp.gp
fi
i=$(($i+1))
...
for dir in $@ ; do 
if (($i<$#)) ; then
echo "'${dir}/lossrate.txt' title '${pn[$i]}' w l lw 5,\\" >> tmp.gp
else
echo "'${dir}/lossrate.txt' title '${pn[$i]}' w l lw 5" >> tmp.gp
fi
i=$(($i+1))
...
for dir in $@ ; do 
if (($i<$#)) ; then
echo "'${dir}/emit.txt' u :1 title '${pn[$i]}' w l lw 5,\\" >> tmp.gp
else
echo "'${dir}/emit.txt' u :1 title '${pn[$i]}' w l lw 5" >> tmp.gp
fi
i=$(($i+1))
...
for dir in $@ ; do 
if (($i<$#)) ; then
echo "'${dir}/emit.txt' u :2 title '${pn[$i]}' w l lw 5,\\" >> tmp.gp
else
echo "'${dir}/emit.txt' u :2 title '${pn[$i]}' w l lw 5" >> tmp.gp
fi
i=$(($i+1))
...
for dir in $@ ; do 
if (($i<$#)) ; then
echo "'${dir}/sigm.txt' title '${pn[$i]}' w l lw 5,\\" >> tmp.gp
else
echo "'${dir}/sigm.txt' title '${pn[$i]}' w l lw 5" >> tmp.gp
fi
i=$(($i+1))
...
for dir in $@ ; do 
if (($i<$#)) ; then
echo "'${dir}/luminosity.txt' title '${pn[$i]}' w l lw 5,\\" >> tmp.gp
else
echo "'${dir}/luminosity.txt' title '${pn[$i]}' w l lw 5" >> tmp.gp
fi
i=$(($i+1))
